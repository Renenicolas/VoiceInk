...
enum OnboardingExperienceCatalog {
    static let steps: [OnboardingExperienceStep] = [
        ...
        OnboardingExperienceStep(
            ...
            subtitle: "Turn your spoken note into a clean email draft with Nino Voice.",
            sampleLabel: "Sample text",
        ...
        OnboardingExperienceStep(
            ...
            title: "Try Rewrite",
            subtitle: "Select the text on the screen, tell Nino Voice the changes you want, and Nino Voice will rewrite the text for you.",
            sampleLabel: "Sample text",
        ...
        OnboardingExperienceStep(
            ...
            subtitle: "Ask quick questions and Nino Voice will serve you the answers.",
