...
struct OnboardingContextAwarenessScreen: View {
    ...
    var body: some View {
        OnboardingStepScreen(
            ...
            title: "Nino Voice is Context-Aware",
            subtitle: "Nino Voice automatically understands what you are working with and selects your preferred setup.",
...
private struct ContextAwarenessCenterSlot: View {
    var body: some View {
        ContextAwarenessModeVisual()
            ...
            .accessibilityLabel("Nino Voice modes include Dictation, Enhance, Email, Assistant, Rewrite, Ask, Summarize, and Translate.")
    }
}
