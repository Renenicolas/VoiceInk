...
struct DashboardContent: View {
    ...
    private var insightsActionHelp: String {
        ...
        return String(localized: "Continue using Nino Voice to unlock these stats.")
    }
    ...
    private var licenseStatusMessage: some View {
        ...
        case .unlicensed:
            TrialMessageView(
                message: Text("Activate a license to continue using Nino Voice."),
    ...
    private var headerSubtitle: String {
        guard hasLoadedStatsSnapshot else {
            return String(localized: "Pulling together your Nino Voice activity.")
        }
    ...
    var body: some View {
        HStack(alignment: .center, spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 3) {
                ...
                Text("Required for Nino Voice shortcuts and app-wide controls to work properly.")
                    .font(.system(size: 11))
