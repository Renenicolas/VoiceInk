...
struct SettingsView: View {
    ...
    var body: some View {
        Form {
            ...
            Section("Pasting") {
                ExpandableSettingsRow(
                    ...
                    infoMessage: "Nino Voice temporarily uses the clipboard to paste transcription. When enabled, it restores your previous clipboard content after the selected delay. When disabled, the pasted transcription stays on your clipboard."
                ) {
        ...
        .alert("Restart Nino Voice to Apply Language", isPresented: $showLanguageRestartAlert) {
